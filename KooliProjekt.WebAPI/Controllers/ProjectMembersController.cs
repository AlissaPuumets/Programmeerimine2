...
namespace KooliProjekt.WebAPI.Controllers
{
    public class ProjectMembersController : ApiControllerBase
    {
        ...
        [HttpGet]
        [Route("List")]
        public async Task<IActionResult> List([FromQuery] ListProjectMembersQuery query)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<IActionResult> Delete(DeleteProjectMembersCommand command)
        {
            var response = await _mediator.Send(command);
