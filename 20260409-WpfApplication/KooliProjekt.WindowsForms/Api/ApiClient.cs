...
namespace KooliProjekt.WindowsForms.Api
{
    public class ApiClient : IApiClient
    {
        ...
        public async Task<OperationResult<PagedResult<ToDoList>>> List(int page, int pageSize)
        {
            ...
            var result = JsonConvert.DeserializeObject<OperationResult<PagedResult<ToDoList>>>(body);
            return result;
        }

        public async Task<OperationResult> Save(ToDoList list)
        {
