...
namespace KooliProjekt.WindowsForms
{
    public partial class Form1 : Form, IMainView
    {
        ...
        public IList<ToDoList> DataSource 
        { 
            get { return (IList<ToDoList>)dataGridView1.DataSource; }
            set { dataGridView1.DataSource = value; } 
        }

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public ToDoList SelectedItem { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        ...
        private void DataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            var selectedList = (ToDoList)dataGridView1.CurrentRow.DataBoundItem;
